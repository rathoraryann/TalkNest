  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ justifyContent: "center", display: "flex", gap: 2 }}>
            <button p={1}>
          ...
          <div style={{display: 'flex', flexDirection: "column", justifyContent: "center", alignItems: "center", gap: 2}}>
              ...
              <br />
              <button style={{border: '2px solid grey', padding: "3px", borderRadius: "6px",backgroundColor: "white", color: "black"}} onClick={()=>logoutHandler()}>Logout</button>
        </div>
      </Box>
